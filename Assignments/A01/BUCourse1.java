...
public class BUCourse1 implements Serializable {
    ...
    public BUCourse1(int semester, int crn, String subj, String crs, 
                    String sec, double cred, String title, LocalTime startTime,
                    LocalTime endTime, String descr, String prereq, int cap,
                    Instructor instructor, InstrMeth method,
